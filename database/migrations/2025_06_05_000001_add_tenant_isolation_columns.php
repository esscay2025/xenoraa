...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('site_settings') && !Schema::hasColumn('site_settings', 'user_id')) {
        ...
        if (!Schema::hasColumn('users', 'tenant_owner_id')) {
            Schema::table('users', function (Blueprint $table) {
                $table->unsignedBigInteger('tenant_owner_id')->nullable()->index();
            });
        }

        // Add user_id to portfolio_experiences for tenant isolation
        if (Schema::hasTable('portfolio_experiences') && !Schema::hasColumn('portfolio_experiences', 'user_id')) {
        ...
        if (Schema::hasTable('social_links') && !Schema::hasColumn('social_links', 'user_id')) {
