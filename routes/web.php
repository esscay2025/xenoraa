...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin', 'subscribed'])->group(function () {
    ...
    Route::prefix('crm2')->name('crm2.')->group(function () {
        ...
        Route::post('/sales/contacts/{id}/clone',    [$ctrl, 'salesContactsClone'])->name('sales.contacts.clone');
        Route::delete('/sales/contacts/bulk-delete', [$ctrl, 'salesContactsBulkDelete'])->name('sales.contacts.bulk-delete');
        Route::post('/sales/contacts/bulk-task',     [$ctrl, 'salesContactsBulkTask'])->name('sales.contacts.bulk-task');
        ...
        Route::post('/sales/accounts/{id}/clone',    [$ctrl, 'salesAccountsClone'])->name('sales.accounts.clone');
        Route::delete('/sales/accounts/bulk-delete', [$ctrl, 'salesAccountsBulkDelete'])->name('sales.accounts.bulk-delete');
        Route::post('/sales/accounts/bulk-task',     [$ctrl, 'salesAccountsBulkTask'])->name('sales.accounts.bulk-task');
        ...
        Route::post('/sales/deals/{id}/clone',       [$ctrl, 'salesDealsClone'])->name('sales.deals.clone');
        Route::delete('/sales/deals/bulk-delete',    [$ctrl, 'salesDealsBulkDelete'])->name('sales.deals.bulk-delete');
        Route::post('/sales/deals/bulk-task',        [$ctrl, 'salesDealsBulkTask'])->name('sales.deals.bulk-task');
        ...
        Route::delete('/inventory/price-books/bulk-delete',              [$ctrl, 'priceBooksBulkDelete'])->name('inventory.price-books.bulk-delete');
        Route::post('/inventory/price-books/{id}/clone',                 [$ctrl, 'priceBookClone'])->name('inventory.price-books.clone');
        Route::delete('/inventory/price-books/{id}',                     [$ctrl, 'priceBookDestroy'])->name('inventory.price-books.destroy');
        Route::get('/inventory/price-books/{id}/export-pdf',             [$ctrl, 'priceBookExportPdf'])->name('inventory.price-books.export-pdf');
        ...
        Route::delete('/inventory/sales-orders/bulk-delete',             [$ctrl, 'salesOrdersBulkDelete'])->name('inventory.sales-orders.bulk-delete');
        Route::post('/inventory/sales-orders/{id}/clone',                [$ctrl, 'salesOrderClone'])->name('inventory.sales-orders.clone');
        Route::delete('/inventory/sales-orders/{id}',                    [$ctrl, 'salesOrderDestroy'])->name('inventory.sales-orders.destroy');
        Route::get('/inventory/sales-orders/{id}/export-pdf',            [$ctrl, 'salesOrderExportPdf'])->name('inventory.sales-orders.export-pdf');
        ...
        Route::post('/inventory/purchase-orders/{id}/attachments',              [$ctrl, 'poAttachmentsStore'])->name('inventory.purchase-orders.attachments.store');
        Route::get('/inventory/purchase-orders/{id}/attachments/{attId}/download', [$ctrl, 'poAttachmentsDownload'])->name('inventory.purchase-orders.attachments.download');
        ...
        Route::delete('/inventory/purchase-orders/bulk-delete',          [$ctrl, 'purchaseOrdersBulkDelete'])->name('inventory.purchase-orders.bulk-delete');
        Route::post('/inventory/purchase-orders/{id}/clone',             [$ctrl, 'purchaseOrderClone'])->name('inventory.purchase-orders.clone');
        Route::delete('/inventory/purchase-orders/{id}',                 [$ctrl, 'purchaseOrderDestroy'])->name('inventory.purchase-orders.destroy');
        Route::get('/inventory/purchase-orders/{id}/export-pdf',         [$ctrl, 'purchaseOrderExportPdf'])->name('inventory.purchase-orders.export-pdf');
        ...
        Route::delete('/inventory/invoices/bulk-delete',                 [$ctrl, 'invoicesBulkDelete'])->name('inventory.invoices.bulk-delete');
        Route::post('/inventory/invoices/{id}/clone',                    [$ctrl, 'invoiceClone'])->name('inventory.invoices.clone');
        Route::delete('/inventory/invoices/{id}',                        [$ctrl, 'invoiceDestroy'])->name('inventory.invoices.destroy');
        Route::get('/inventory/invoices/{id}/export-pdf',                [$ctrl, 'invoiceExportPdf'])->name('inventory.invoices.export-pdf');
        ...
        Route::delete('/inventory/vendors/bulk-delete',                  [$ctrl, 'vendorsBulkDelete'])->name('inventory.vendors.bulk-delete');
        Route::post('/inventory/vendors/{id}/clone',                     [$ctrl, 'vendorClone'])->name('inventory.vendors.clone');
        Route::delete('/inventory/vendors/{id}',                         [$ctrl, 'vendorDestroy'])->name('inventory.vendors.destroy');
        Route::get('/inventory/vendors/{id}/export-pdf',                 [$ctrl, 'vendorExportPdf'])->name('inventory.vendors.export-pdf');
...
Route::prefix('')->name('xenoraa.')->group(function () {
    ...
    Route::get('/xenoraa/blog/{slug}', [XenoraaController::class, 'blogShow'])->name('blog.show');
