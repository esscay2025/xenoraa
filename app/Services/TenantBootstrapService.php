    ...
    private function consultantConfig(string $name, string $email, string $username): array
    {
        return [
            'settings' => [
                ...
                'profile_title'       => 'Senior IT Consultant & Digital Transformation Specialist',
                'profile_about'       => $name . ' is a senior IT consultant and digital transformation specialist with 15+ years of experience helping Fortune 500 companies and startups modernise their technology infrastructure. Specialising in cloud migration, AI/ML implementation, and enterprise architecture.',
                'profile_years'       => '15+',
                'profile_clients'     => '200+',
                'profile_projects'    => '500+',
                'profile_revenue'     => '$50M+',
                'profile_booking_link'=> '/contact',
                'contact_email'       => $email,
                'profile_expertise'   => json_encode(['Cloud Architecture', 'Digital Transformation', 'AI/ML', 'Enterprise Architecture', 'Agile', 'DevOps']),
            ],
            'pages' => [
                [
                    'title'      => 'Home',
    ...
    private function influencerConfig(string $name, string $email, string $username): array
    {
        return [
            'settings' => [
                ...
                'profile_title'              => 'Lifestyle & Fashion Creator',
                'profile_handle'             => '@' . strtolower(str_replace(' ', '', $name)),
                'profile_niche'              => 'Lifestyle · Fashion · Travel · Wellness',
                'profile_followers_total'    => '850K+',
                'profile_instagram_followers'=> '450K',
                'profile_youtube_subscribers'=> '280K',
                'profile_twitter_followers'  => '120K',
                'profile_tiktok_followers'   => '200K',
                'profile_instagram'          => 'https://instagram.com/' . strtolower(str_replace(' ', '', $name)),
                'profile_youtube'            => 'https://youtube.com/@' . strtolower(str_replace(' ', '', $name)),
                'profile_twitter'            => 'https://twitter.com/' . strtolower(str_replace(' ', '', $name)),
                'profile_collab_email'       => 'collabs@' . strtolower(str_replace(' ', '', $name)) . '.com',
                'profile_about'              => $name . ' is a top lifestyle and fashion content creator with 850K+ followers across platforms. Known for authentic storytelling, stunning visuals, and genuine brand partnerships, ' . $name . ' creates content that inspires millions daily.',
                'profile_years'              => '6+',
                'profile_clients'            => '120+',
                'profile_projects'           => '500+',
                'contact_email'              => $email,
    ...
    private function advocateConfig(string $name, string $email, string $username): array
    {
        return [
            'settings' => [
                ...
                'profile_title'         => 'Advocate & Legal Consultant',
                'profile_enrollment_no' => 'TN/2006/12345',
                'profile_bar_number'    => 'TN/2006/12345',
                'profile_court'         => 'Madras High Court & Supreme Court of India',
                'contact_address'       => 'Chamber No. 42, Madras High Court Annexe, Chennai 600 104',
                'profile_booking_link'  => '/contact',
                'profile_about'         => $name . ' is a distinguished advocate with 18+ years of experience in corporate law, intellectual property, and dispute resolution. Enrolled with the Bar Council of Tamil Nadu, ' . $name . ' has successfully represented clients before the Madras High Court, NCLT, and the Supreme Court of India.',
                'profile_years'         => '18+',
                'profile_clients'       => '800+',
                'profile_projects'      => '1200+',
                'profile_cases_won'     => '1200+',
                'contact_phone'         => '+91 98765 43210',
                'contact_email'         => $email,
                'profile_practice_areas'=> json_encode(['Civil Litigation', 'Criminal Defense', 'Corporate Law', 'Family Law', 'Property Law', 'Contract Drafting']),
            ],
            'pages' => [
                [
                    'title'      => 'Home',
    ...
    private function doctorConfig(string $name, string $email, string $username): array
    {
        return [
            'settings' => [
                ...
                'profile_title'            => 'MBBS, MD — General Physician & Wellness Consultant',
                'profile_registration_no'  => 'TN-MED-2004-98765',
                'profile_appointment_link' => '/appointments',
                'profile_clinic'           => $name . ' Medical Centre, Anna Nagar, Chennai',
                'profile_timings'          => 'Mon–Sat: 9am–1pm & 5pm–8pm',
                'profile_booking_link'     => '/appointments',
                'profile_about'            => 'Dr. ' . $name . ' is a highly experienced General Physician and Wellness Consultant with 20+ years of clinical practice. A graduate of Madras Medical College with MD from AIIMS New Delhi, Dr. ' . $name . ' has treated 50,000+ patients with a compassionate, evidence-based approach.',
                'profile_years'            => '20+',
                'profile_clients'          => '50K+',
                'profile_projects'         => '98%',
                'contact_phone'            => '+91 98765 43210',
                'contact_email'            => $email,
                'contact_address'          => $name . ' Medical Centre, Anna Nagar, Chennai 600 040',
                'profile_specialties'      => json_encode(['General Medicine', 'Preventive Care', 'Chronic Disease Management', 'Wellness Consulting']),
            ],
            'pages' => [
                [
                    'title'      => 'Home',
    ...
    private function entrepreneurConfig(string $name, string $email, string $username): array
    {
        return [
            'settings' => [
                ...
                'profile_funding_raised' => '$10M+',
                'profile_team_size'      => '200+',
                'profile_pitch_link'     => '/contact',
                'profile_linkedin'       => 'https://linkedin.com/in/' . strtolower(str_replace(' ', '-', $name)),
                'profile_about'          => $name . ' is a serial entrepreneur who has founded and scaled 5+ ventures across technology, consumer goods, and services. With $10M+ in funding raised and 200+ team members across ventures, ' . $name . ' brings deep operational expertise and a track record of building businesses from zero to scale.',
                'profile_years'          => '12+',
                'profile_clients'        => '50+',
                'profile_projects'       => '5+',
                'contact_email'          => $email,
                'profile_industries'     => json_encode(['Technology', 'Consumer Goods', 'Education', 'Healthcare']),
            ],
            'pages' => [
                [
                    'title'      => 'Home',
    ...
    private function politicianConfig(string $name, string $email, string $username): array
    {
        return [
            'settings' => [
                ...
                'profile_title'           => 'Member of Legislative Assembly',
                'profile_constituency'    => 'North Chennai Constituency',
                'profile_party'           => 'People\'s Progressive Alliance',
                'profile_years'           => '12+',
                'profile_clients'         => '5L+',
                'profile_projects'        => '150+',
                'profile_about'           => $name . ' has dedicated 12+ years to public service, working tirelessly for the development and welfare of the North Chennai Constituency. Known for delivering on promises of infrastructure, education, and economic opportunity, ' . $name . ' has secured ₹500Cr+ in central government development funds.',
                'contact_phone'           => '+91 98765 43210',
                'contact_email'           => $email,
                'contact_address'         => 'Constituency Office, North Chennai, Tamil Nadu 600 001',
            ],
            'pages' => [
                [
                    'title'      => 'Home',
