...
<div class="cf-page">
  ...
  <div class="xn-sticky-bar">
    ...
    <div class="xn-sticky-actions">
      <a href="{{ route('admin.crm2.inventory.vendors') }}" class="xn-sticky-btn xn-sticky-btn-ghost">
        <i class="fas fa-arrow-left"></i> Cancel
      </a>
      <button type="submit" form="vendorCreateForm" class="xn-sticky-btn xn-sticky-btn-primary">
  ...
  <div class="xn-sticky-spacer"></div>
    ...
    <form id="vendorCreateForm" method="POST" action="{{ route('admin.crm2.inventory.store') }}">
        @csrf
        ...
        <div class="cf-section">
            ...
            <div class="cf-section-body">
                <div class="cf-grid cf-grid-3">
                    ...
                    <div class="cf-field"><label>Vendor Name *</label>
                        <input type="text" name="name" required value="{{ old('name') }}" placeholder="Company or vendor name"></div>
                    <div class="cf-field"><label>Phone</label>
                        <input type="text" name="phone" value="{{ old('phone') }}"></div>
                    <div class="cf-field"><label>Email</label>
                        <input type="email" name="email" value="{{ old('email') }}"></div>
                    <div class="cf-field"><label>Website</label>
                        <input type="url" name="website" value="{{ old('website') }}" placeholder="https://"></div>
                    <div class="cf-field"><label>GL Account</label>
                        <input type="text" name="gl_account" value="{{ old('gl_account') }}"></div>
                    <div class="cf-field"><label>Category</label>
                        <input type="text" name="category" value="{{ old('category') }}" placeholder="e.g. Supplier, Contractor"></div>
                    ...
                    <div class="cf-field"><label>Currency</label>
                        ...
                        @foreach(['INR'=>'INR (₹)','USD'=>'USD ($)','EUR'=>'EUR (€)','GBP'=>'GBP (£)'] as $v=>$l)
        ...
        <div class="cf-section">
            ...
            <div class="cf-section-body">
                <div class="cf-grid cf-grid-3">
                    <div class="cf-field"><label>Country</label><input type="text" name="country" value="{{ old('country') }}"></div>
                    <div class="cf-field"><label>Building / Apartment</label><input type="text" name="building" value="{{ old('building') }}"></div>
                    <div class="cf-field"><label>Street</label><input type="text" name="street" value="{{ old('street') }}"></div>
                    <div class="cf-field"><label>City</label><input type="text" name="city" value="{{ old('city') }}"></div>
                    <div class="cf-field"><label>State</label><input type="text" name="state" value="{{ old('state') }}"></div>
                    <div class="cf-field"><label>Zip / Postal Code</label><input type="text" name="zip" value="{{ old('zip') }}"></div>
                </div>
            </div>
        </div>
        ...
        <div class="cf-section">
            ...
            <div class="cf-section-body">
                <div class="cf-field">
                    ...
                    <textarea name="description" rows="4" placeholder="Vendor description...">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>

        <div class="cf-actions">
            <button type="submit" class="cf-btn cf-btn-primary">&#10003; Save Vendor</button>
