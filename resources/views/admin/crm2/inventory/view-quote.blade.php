...
<div class="send-mail-panel no-print" id="sendMailPanel">
    ...
    <div class="send-mail-body">
        ...
        <form method="POST" action="{{ route('admin.crm2.inventory.send-mail', ['type'=>'quote','id'=>$item->id]) }}">
            @csrf
