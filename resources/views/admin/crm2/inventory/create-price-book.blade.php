...
<div class="cf-page">
  ...
  <div class="xn-sticky-bar">
    ...
    <div class="xn-sticky-actions">
      <a href="{{ route('admin.crm2.inventory.price-books') }}" class="xn-sticky-btn xn-sticky-btn-ghost">
        <i class="fas fa-arrow-left"></i> Cancel
      </a>
      <button type="submit" form="priceBookCreateForm" class="xn-sticky-btn xn-sticky-btn-primary">
        <i class="fas fa-save"></i> Save Price Book
      </button>
    </div>
  </div>
  <div class="xn-sticky-spacer"></div>
    ...
    <div class="cf-header">
        <a href="{{ route('admin.crm2.inventory.price-books') }}" class="cf-back">&#8592; Price Books</a>
        <h1>New Price Book</h1>
    </div>
    <form id="priceBookCreateForm" method="POST" action="{{ route('admin.crm2.inventory.store') }}">
        @csrf
        <input type="hidden" name="type" value="price_book">

        <div class="cf-section">
            <div class="cf-section-header" onclick="toggleSection(this)">
                <h3>Price Book Information</h3><span class="cf-chevron">&#9660;</span>
            </div>
            <div class="cf-section-body">
                <div class="cf-grid cf-grid-3">
                    <div class="cf-field">
                        <label>Price Book Owner</label>
                    ...
                    <div class="cf-field">
                        ...
                        <input type="text" name="name" required value="{{ old('name') }}" placeholder="Enter price book name">
                    </div>
                    <div class="cf-field">
                    ...
                    <div class="cf-field">
                        ...
                        <input type="number" name="pricing_percentage" step="0.01" value="{{ old('pricing_percentage') }}" placeholder="0.00">
                    </div>
                    <div class="cf-field">
        ...
        <div class="cf-section">
            <div class="cf-section-header" onclick="toggleSection(this)">
                <h3>Description Information</h3><span class="cf-chevron">&#9660;</span>
            </div>
            <div class="cf-section-body">
                <div class="cf-field">
        ...
        <div class="cf-actions">
            <button type="submit" class="cf-btn cf-btn-primary">&#10003; Save Price Book</button>
            <a href="{{ route('admin.crm2.inventory.price-books') }}" class="cf-btn cf-btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
