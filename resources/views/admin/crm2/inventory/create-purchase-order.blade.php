...
<div class="cf-page">
    ...
    <form method="POST" action="{{ route('admin.crm2.inventory.store') }}" onsubmit="serializeLineItems('po_items','po_items_json')">
        @csrf
            ...
            <div class="cf-section-body">
                <div class="cf-grid cf-grid-3">
                    ...
                    <div class="cf-field"><label>Subject *</label>
                        <input type="text" name="subject" required value="{{ old('subject') }}" placeholder="PO subject"></div>
                    <div class="cf-field"><label>Status</label>
                        <select name="status">
                        @foreach(['Created','Approved','Delivered','Cancelled'] as $s)
                        <option value="{{ $s }}">{{ $s }}</option>@endforeach</select>
                    </div>
                    ...
                    <div class="cf-field"><label>Tracking Number</label>
                        <input type="text" name="tracking_number" value="{{ old('tracking_number') }}"></div>
                    <div class="cf-field"><label>Purchase Order Date</label>
                        <input type="date" name="po_date" value="{{ old('po_date') }}"></div>
                    <div class="cf-field"><label>Due Date</label>
                        <input type="date" name="delivery_date" value="{{ old('delivery_date') }}"></div>
                    <div class="cf-field"><label>Sales Order Ref.</label>
                        <input type="text" name="sales_order_ref" value="{{ old('sales_order_ref') }}"></div>
                    <div class="cf-field"><label>Requisition No.</label>
                        <input type="text" name="requisition_no" value="{{ old('requisition_no') }}"></div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem">
                    <div>
                        ...
                        <div class="cf-grid" style="grid-template-columns:1fr 1fr">
                            <div class="cf-field cf-field-full"><label>Country</label><input type="text" name="bill_country" value="{{ old('bill_country') }}"></div>
                            <div class="cf-field cf-field-full"><label>Building</label><input type="text" name="bill_building" value="{{ old('bill_building') }}"></div>
                            <div class="cf-field cf-field-full"><label>Street</label><input type="text" name="bill_street" value="{{ old('bill_street') }}"></div>
                            <div class="cf-field"><label>City</label><input type="text" name="bill_city" value="{{ old('bill_city') }}"></div>
                            <div class="cf-field"><label>State</label><input type="text" name="bill_state" value="{{ old('bill_state') }}"></div>
                            <div class="cf-field"><label>Zip</label><input type="text" name="bill_zip" value="{{ old('bill_zip') }}"></div>
                        </div>
                    </div>
                    <div>
        ...
        <div class="cf-section">
            ...
            <div class="cf-section-body">
                ...
                <table class="li-table" id="po_items">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="li-qty" value="1" min="1" style="width:60px" oninput="recalcTotals('po_items')"></td>
                            <td><input type="number" class="li-price" step="0.01" value="0" style="width:90px" oninput="recalcTotals('po_items')"></td>
                            <td><input type="number" class="li-amt" step="0.01" value="0" style="width:90px" readonly></td>
                            <td><input type="number" class="li-disc" step="0.01" value="0" style="width:80px" oninput="recalcTotals('po_items')"></td>
                            <td><input type="number" class="li-tax" step="0.01" value="0" style="width:80px" oninput="recalcTotals('po_items')"></td>
                ...
                <div class="li-summary">
                    <div class="li-summary-row"><label>Sub Total (₹)</label><input type="number" id="po_items_subtotal" name="subtotal" step="0.01" value="0" readonly></div>
                    <div class="li-summary-row"><label>Discount (₹)</label><input type="number" id="po_items_discount" name="discount_amount" step="0.01" value="0" oninput="recalcTotals('po_items')"></div>
                    <div class="li-summary-row"><label>Tax (₹)</label><input type="number" id="po_items_tax" name="tax_amount" step="0.01" value="0" oninput="recalcTotals('po_items')"></div>
                    <div class="li-summary-row"><label>Adjustment (₹)</label><input type="number" id="po_items_adjustment" name="adjustment" step="0.01" value="0" oninput="recalcTotals('po_items')"></div>
                    <div class="li-summary-row li-grand-total"><label>Grand Total (₹)</label><input type="number" id="po_items_grand" name="grand_total" step="0.01" value="0" readonly></div>
                </div>
            </div>
        </div>
        ...
        <div class="cf-actions">
            <button type="submit" class="cf-btn cf-btn-primary">&#10003; Save Purchase Order</button>
