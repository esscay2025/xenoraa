...
<div class="cf-page">
  ...
  <div class="xn-sticky-bar">
    ...
    <div class="xn-sticky-actions">
      <a href="{{ route('admin.crm2.inventory.purchase-orders') }}" class="xn-sticky-btn xn-sticky-btn-ghost">
        <i class="fas fa-arrow-left"></i> Cancel
      </a>
      <button type="submit" form="poCreateForm" class="xn-sticky-btn xn-sticky-btn-primary">
  ...
  <div class="xn-sticky-spacer"></div>
    ...
    <form id="poCreateForm" method="POST" action="{{ route('admin.crm2.inventory.store') }}" onsubmit="serializeLineItems('po_items','po_items_json')">
        @csrf
