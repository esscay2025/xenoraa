...
<div class="cf-page">
  ...
  <div class="xn-sticky-bar">
    ...
    <div class="xn-sticky-actions">
      <a href="{{ route('admin.crm2.inventory.products') }}" class="xn-sticky-btn xn-sticky-btn-ghost">
        <i class="fas fa-arrow-left"></i> Cancel
      </a>
      <button type="submit" form="productCreateForm" class="xn-sticky-btn xn-sticky-btn-primary">
  ...
  <div class="xn-sticky-spacer"></div>
    ...
    <form id="productCreateForm" method="POST" action="{{ route('admin.crm2.inventory.products.store') }}" enctype="multipart/form-data">
        @csrf
