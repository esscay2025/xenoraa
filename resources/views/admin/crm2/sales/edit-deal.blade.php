  ...
  <div class="crm2-card"><div class="crm2-card-body">
    <form method="POST" action="{{ route('admin.crm2.sales.update', ['type'=>'deal','id'=>\$item->id]) }}">@csrf @method('PATCH')
      <div class="crm2-form-grid">
        ...
        <div class="form-group"><label>Expected Close Date</label><input type="date" name="expected_close_date" class="crm2-input" value="{{ old('expected_close_date', $item->expected_close_date ? $item->expected_close_date->format('Y-m-d') : '') }}"></div>
