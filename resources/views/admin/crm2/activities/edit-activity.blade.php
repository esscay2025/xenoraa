...
<div class="crm2-page">
  <div class="crm2-header">
    <div><h1 class="crm2-title"><i class="fas fa-edit"></i> Edit {{ ucfirst($type) }}</h1><p class="crm2-subtitle">Update the activity details below.</p></div>
  ...
  <div class="crm2-card"><div class="crm2-card-body">
    <form method="POST" action="{{ route('admin.crm2.activity.update', $item->id) }}">@csrf @method('PATCH')
      <div class="crm2-form-grid">
        ...
        <div class="form-group"><label>Due Date</label><input type="datetime-local" name="due_date" class="crm2-input" value="{{ old('due_date', $item->due_date ? $item->due_date->format('Y-m-d\TH:i') : '') }}"></div>
      ...
      <div style="display:flex;gap:1rem;margin-top:1.5rem;">
        <button type="submit" class="crm2-btn crm2-btn-primary"><i class="fas fa-save"></i> Update {{ ucfirst($type) }}</button>
