...
<div class="crm2-page">
  <div class="crm2-header">
    <div><h1 class="crm2-title"><i class="fas fa-plus-circle"></i> New {{ ucfirst($type) }}</h1><p class="crm2-subtitle">Schedule a new {{ $type }} activity.</p></div>
  ...
  <div class="crm2-card"><div class="crm2-card-body">
    <form method="POST" action="{{ route('admin.crm2.activity.store') }}">@csrf
      ...
      <div class="crm2-form-grid">
        ...
        <div class="form-group"><label>Due Date</label><input type="datetime-local" name="due_date" class="crm2-input"></div>
