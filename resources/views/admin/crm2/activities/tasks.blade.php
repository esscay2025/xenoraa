...
<div class="crm2-page">
  <div class="crm2-header">
    <div><h1 class="crm2-title"><i class="fas fa-check-square"></i> Tasks</h1><p class="crm2-subtitle">Manage your CRM tasks.</p></div>
    <a href="{{ route('admin.crm2.activities.tasks.create') }}" class="crm2-btn crm2-btn-primary"><i class="fas fa-plus"></i> New Task</a>
  </div>
  ...
  <div class="crm2-card mb-4"><div class="crm2-card-body">
    <form method="GET" class="crm2-filter-form">
      ...
      <a href="{{ route('admin.crm2.activities.tasks') }}" class="crm2-btn crm2-btn-ghost"><i class="fas fa-times"></i></a>
    </form>
  </div></div>
  <div class="crm2-card"><div class="crm2-card-body p-0">
    <table class="crm2-table">
      ...
      <tbody>
        ...
        @empty
        <tr><td colspan="6"><div class="crm2-empty"><i class="fas fa-check-square"></i><p>No tasks found.</p></div></td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
