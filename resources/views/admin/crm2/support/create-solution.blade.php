...
<div class="crm2-page">
  ...
  <div class="xn-sticky-bar">
    ...
    <div class="xn-sticky-actions">
      <a href="{{ route('admin.crm2.support.solutions') }}" class="xn-sticky-btn xn-sticky-btn-ghost">
        <i class="fas fa-arrow-left"></i> Cancel
      </a>
      <button type="submit" form="solutionCreateForm" class="xn-sticky-btn xn-sticky-btn-primary">
  ...
  <div class="crm2-card"><div class="crm2-card-body">
    <form id="solutionCreateForm" method="POST" action="{{ route('admin.crm2.support.store') }}">@csrf
