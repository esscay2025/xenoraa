  ...
  <div class="crm2-card mb-4">
    <div class="crm2-card-body">
      <form method="GET" class="crm2-filter-form" style="flex-wrap:nowrap;">
        <div class="filter-group flex-1"><input type="text" name="search" value="{{ request('search') }}" placeholder="Search entries..." class="crm2-input"></div>
      ...
      <table class="crm2-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family:monospace;font-size:.78rem;color:var(--crm-secondary);">{{ $entry->reference_number }}</td>
            ...
            <td style="text-align:right;font-weight:600;color:var(--crm-success);">₹{{ number_format($entry->lines->sum('credit_amount'), 2) }}</td>
            <td>
              ...
              <table class="crm2-table" style="font-size:.78rem;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align:right;color:var(--crm-success);">{{ $line->credit_amount ? '₹'.number_format($line->credit_amount,2) : '—' }}</td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
  ...
  <div class="crm2-card" style="width:100%;max-width:640px;margin:1rem;">
    <div class="crm2-card-body">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;">
        ...
        <button onclick="document.getElementById('addJournalModal').style.display='none'" style="background:none;border:none;color:var(--crm-secondary);font-size:1.2rem;cursor:pointer;"><i class="fas fa-times"></i></button>
      </div>
      <form method="POST" action="{{ route('admin.accounts.journal.store') }}">
        ...
        <div style="font-size:.8rem;font-weight:600;color:var(--crm-text);margin-bottom:.5rem;">Journal Lines</div>
        <div id="journalLines">
