...
<div class="crm2-page">
  <div class="crm2-header">
    <div>
      <h1 class="crm2-title"><i class="fas fa-arrow-circle-up" style="color:var(--crm-danger);"></i> Expenses</h1>
    </div>
  ...
  <div class="crm2-card mb-4">
    <div class="crm2-card-body">
      <form method="GET" class="crm2-filter-form" style="flex-wrap:nowrap;">
        <div class="filter-group flex-1"><input type="text" name="search" value="{{ request('search') }}" placeholder="Search expenses..." class="crm2-input"></div>
      ...
      <table class="crm2-table" id="expTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family:monospace;font-size:.78rem;color:var(--crm-secondary);">{{ $exp->reference_number }}</td>
            <td>{{ $exp->expense_date->format('d M Y') }}</td>
            <td style="font-weight:600;color:var(--crm-primary);">{{ $exp->title }}</td>
            <td>{{ $exp->category ?? '—' }}</td>
            ...
            <td style="text-align:right;font-weight:700;color:var(--crm-danger);">₹{{ number_format($exp->amount, 2) }}</td>
  ...
  <div class="crm2-card" style="width:100%;max-width:520px;margin:1rem;">
    <div class="crm2-card-body">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;">
        ...
        <button onclick="document.getElementById('addExpenseModal').style.display='none'" style="background:none;border:none;color:var(--crm-secondary);font-size:1.2rem;cursor:pointer;"><i class="fas fa-times"></i></button>
      </div>
